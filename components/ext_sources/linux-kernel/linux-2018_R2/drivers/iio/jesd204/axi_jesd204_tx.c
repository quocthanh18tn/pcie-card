...
{
	pr_notice("Call to axi_jesd204_tx_lane_clk_enable\n");
...
{
	pr_notice("Call to axi_jesd204_tx_lane_clk_disable\n");
	struct axi_jesd204_tx *jesd =
		container_of(clk, struct axi_jesd204_tx, dummy_clk);
...
static int axi_jesd204_tx_lane_clk_prepare(struct clk_hw *hw)
{
	pr_notice("Call to axi_jesd204_tx_lane_clk_prepare\n");
	return 0;
}

static void axi_jesd204_tx_lane_clk_unprepare(struct clk_hw *hw)
{
	pr_notice("Call to axi_jesd204_tx_lane_clk_unprepare\n");
}
...
static const struct clk_ops axi_jesd204_tx_dummy_clk_ops = {
	...
	.prepare = axi_jesd204_tx_lane_clk_prepare,
	.unprepare = axi_jesd204_tx_lane_clk_unprepare,
};
...
static int axi_jesd204_tx_probe(struct platform_device *pdev)
{
	...
	pr_notice("axi_jesd204_tx_probe : %s\n", pdev->dev.of_node->name);
 ...
 */
	...
	pr_notice("axi_jesd204_tx_probe : %s successfully\n", pdev->dev.of_node->name);
	return 0;
...
err_axi_clk_disable:
	...
	pr_notice("axi_jesd204_tx_probe : %s failed with ret = %d\n", pdev->dev.of_node->name, ret);
	return ret;
}
