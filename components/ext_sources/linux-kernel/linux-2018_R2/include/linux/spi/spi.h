...
#define SPI_LE_MODE	0x1000			/* LE mode for ADL5243*/
#define SPI_TX		1 				/* EVT2 change write state from 0 to 1*/
#define SPI_RX		0 				/* EVT2 change read state from 1 to 0*/
    ...
    int                     (*extra_cs)(struct spi_device *spi);  /*fli. for viettel rru  */
	void			(*prepare_transfer)(int mode);
    int                     real_cs;          /* fli, for viettel rru */
